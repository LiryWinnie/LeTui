...
public class step2 {
	...
	//输出文件的相对路径
	private static String outPath = "/Movie/step2_output";
	//将step1输出的转置矩阵作为全局缓存
	...
	public int run() {
		try {
		   ...
		   //添加分布式缓存文件夹
		   job.addCacheFile(new URI(cache+"#itemUserScore"));
